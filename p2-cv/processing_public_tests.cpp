...
void test_energy(const Matrix *energy_mat, string prefix){
  ...
  //changed
  // Matrix_print(energy_mat, std::cout);
  // Matrix_print(energy_mat_correct, std::cout);
  //
...
void test_cost(const Matrix *cost_mat, string prefix){
  ...
  //changed
  // cout << "\nActual: \n";
  // Matrix_print(cost_mat, std::cout);
  // cout << "\nExpected: " << endl; 
  // Matrix_print(cost_mat_correct, std::cout);
  //
  // cout << "\nCost at index 0: " <<  *Matrix_at(cost_mat_correct, 44, 0) << endl;
  // cout << "\nCost at index 12: " << *Matrix_at(cost_mat_correct, 44, 12) << endl;
...
void test_remove_seam(const Image* img, const int seam[],
  ...
  // Image_print(removed_img, cout);
  // cout << "\nExpected:\n ";
  // Image_print(removed_img_correct, cout);
  //
...
void test_seam_carve(const Image *img, string prefix,
  ...
  //changed
  // cout << "\nActual: \n";
  // Image_print(carved_img, cout);
  // cout << "\nExpected: \n";
  // Image_print(carved_img_correct, cout);
